...
class ClientPaginate{
	...
	function getPreviousPage()
	{
		...
		{
			return "<a href='".$this->url.$this->urlAppendString."start=".($this->start-$this->limit)."' title='Previous page'>« prev</a>";
		}
	...
	function getNextPage()
	{
		...
		{
			return "<a href='".$this->url.$this->urlAppendString."start=".($this->start+$this->limit)."' title='Next page'>next »</a>";
        }
	/*	*/
	}
	...
	function getFirstPage()
	{
		if ($this->currentPage > 1)
		{
			return "<a href='".$this->url.$this->urlAppendString."start=1' title='First page'>« first</a>";
         }
	...
	function getLastPage()
	{
		if($this->currentPage < $this->numPages)
		{
			...
			if ($start_val > $this->num)			
             ...
             return "<a href='".$this->url.$this->urlAppendString."start=".$start_val."' title='Last page'>last »</a>";
		}
/*  */
