            ...
            buttons: {
                "Save": function() {
                   ...
                   // bValid = bValid && checkLength( degree, "degree", 2, 16 );
                    ...
                    if ( bValid ) {
					param = "action=addExperience&id="+jQuery("#expId").val()+"&job_title="+jQuery("#job_title").val()+"&company="+jQuery("#company").val()+"&start_month="+jQuery("#st_month").val()+"&end_month="+jQuery("#e_month").val()+"&start_year="+jQuery("#st_year").val()+"&end_year="+jQuery("#e_year").val()+"&job_description="+jQuery("#job_description").val();
					//alert("param "+param);
					jQuery.ajax({
							   type		: "GET",
							   data 	: param,
		...
		var url	= '../ajax/action.php?action=edit&id='+id;	
				$.get(url,{language: "php", version: 5},  
					function(responseText){ 
						...
						obj = JSON.parse(json);
						//alert(obj.start_year+' '+obj.end_year);
   ...
   <div id="profile-warrper">
    ...
    <div class="profile-second-white-box">
      ...
      <div class="profile-name"> 
        ...
        <div class="profile-profession"> <h4>  <?php echo $company;?>  </h4> </div>
        <div class="profile-company-address"> <p>   <?php echo $address;?> </p> </div>
  ...
  <div class="popup-box"> 
   ...
   <div class="popup-form">
      ...
      <div class="popup-form-row">
         ...
         <div class="popup-box-input"> <input class="text ui-widget-content ui-corner-all" type="text" name="subject" id="subject"> </div>
      </div>
      <div class="popup-form-row">
      ...
      <div class="popup-form-row">
         ...
         <div class="popup-box-input"> <textarea name="edu_description" id="edu_description"  style="width: 255px; height: 87px;"> </textarea> </div>
                    <input type="hidden" name="eduId" id="eduId"> </div>
   ...
   <div class="popup-form">
      ...
      <div class="popup-form-row">
         ...
         <div class="popup-box-input"> <textarea id="job_description" name="job_description"> </textarea> </div>
                    <input type="hidden" name="exp" id="expId"> </div>
