...
//printArray($cat_Array);
	...
	$qry = "and pub_users.status=1 AND pub_users.user_type= ".EXPERT." " ;
	$_pageurl = '';
...
*/
    ...
    INNER JOIN pub_users 
        ON (pub_users_categories_map.user_id = pub_users.id) ",$qry); 
      ...
      <div class="profile-third-white-box">
        ...
        <div class="profile-third-box-detail job-list-margin">
          <div class="eductaion-heading"> <span class="job-post-title">
            ...
            <input type="button" value="View Profile" onclick="window.location='<?php echo SITE_ROOT;?>media/viewprofile.php?profile_id=<?php echo $Data_row['id']?>'">
            <?php }else{
				?>
