...
$link_URL = "prm-manage.php?start=".$start;
$_pageurl = "prm-manage.php";
          ...
          <tr>
            ...
            <td valign="top" align="center">
              <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tbllisting">
                <tr>
                  <td colspan="2" align="left" class="mainhead">Manage Public Relation Manager</td>
                </tr>
                <tr>
                  <td colspan="3"><div class="breadCrumbHolder module">
                      <div class="breadCrumb module">
                        <ul>
                          ...
                          <li>Manage  Public Relation Manager</li>
                        </ul>
                      </div>
                    </div></td>
                </tr>
                    ...
                    <table cellpadding="4" cellspacing="0" width="99%" align="center">
                      <tr>
                       <!-- <td width="22%" class="content_table_head_td" >Username&nbsp; <a href="<?php echo $link_URL;?>&sort=desc&field=user_name"><img src="../images/up.png" height="8" border="0" /></a> <a href="<?php echo $link_URL;?>&sort=asc&field=user_name"><img src="../images/down.png" height="8" border="0"/></a></td> -->
                        <td width="10%" class="content_table_head_td" align="center">First Name</td>
                        <td width="10%" class="content_table_head_td" align="center">Last Name</td>						
                        <td width="18%" class="content_table_head_td" align="center">Email</td>
                        <td width="11%" class="content_table_head_td" align="center">Last Login</td>
                        <td width="10%" class="content_table_head_td" align="center">Current Login</td>
                        ...
                        <td width="31%" class="content_table_head_td" align="center">Action</td>
                      </tr>
                      <?php
                      ...
                      <tr bgcolor="<?php echo $bgColor;?>">
                        ...
                        <td align="center" valign="top" class="content_table_data_td_border_lrb"> <a href="user-expertise-manage.php?user=<?php echo $Data_Row['id']?>" title="Manage PRM Expertises"><img src="../images/userexpertie.png" height="16" width="16" border="0" /></a> | <a href="<?php echo $link_URL?>&act=del&delid=<?php echo $Data_Row['id']; ?>" title="Delete" onClick="return callDel('Are you sure to delete this record?');"> <img src="../images/delete.gif" width="16" height="16" border="0" /></a></td>
                      </tr>
                      <?php
										}
if($paging)
