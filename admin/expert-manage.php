...
$link_URL = "expert-manage.php?start=".$start;
$_pageurl = "expert-manage.php";
          ...
          <tr>
            ...
            <td valign="top" align="center">
              <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tbllisting">
                <tr>
                  <td colspan="2" align="left" class="mainhead">Manage Experts</td>
                </tr>
                <tr>
                  ...
                  <td colspan="2"><!--CONTENTS TABLE-->
                    ...
                    <table cellpadding="4" cellspacing="0" width="99%" align="center">
                      ...
                      <tr bgcolor="<?php echo $bgColor;?>">
                        ...
                        <td align="center" valign="top" class="content_table_data_td_border_lrb Verdana_Bold_11_Link"> <a href="user-expertise-manage.php?user=<?php echo $Data_Row['id']?>" title="Manage Expert Expertises"><img src="../images/userexpertie.png" height="16" width="16" border="0" /></a> | <a href="<?php echo $link_URL?>&act=del&delid=<?php echo $Data_Row['id']; ?>" title="Delete" onClick="return callDel('Are you sure to delete this record?');"> <img src="../images/delete.gif" width="16" height="16" border="0" /></a></td>
                      </tr>
                      <?php
										}
if($paging)
