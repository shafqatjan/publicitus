...
$link_URL = "faq-manage.php?start=".$start;
$_pageurl = "faq-manage.php";
...
{ 
	$objFAQ->id = $editid; 
	$objFAQ->status = $status;	
   	$sql = $objFAQ->StatusUpdate();
...
if(isset($_POST['btn_save']))
{
	...
	$status = intval(!empty($_POST['status']))?$_POST['status']:"2";	
	$hdnid = intval(!empty($_POST['hdnid'])?$_POST['hdnid']:"");
	
	
	$objFAQ->title = $title;
	$objFAQ->description = $description;

	$objFAQ->status = $status;	
	$objFAQ->id = $hdnid;
		
		
	$error .= $objFAQ->validate();
	if(!$error)	
	{
		if($objFAQ->id)
			  $sqlusername = $objFAQ->PopulateGrid("1", " AND title = '".$objFAQ->title."' AND id !=".$objFAQ->id);
		 else 
			  $sqlusername = $objFAQ->PopulateGrid("1", " AND title ='".$objFAQ->title."'");
...
$total = $objDb->GetCountSql($objFAQ->table); 
          ...
          <tr>
            ...
            <td valign="top" align="center">
              <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tbllisting">
                <tr>
                  <td colspan="2" align="left" class="mainhead">Manage FAQs</td>
                </tr>
                <tr>
				  ...
				  ?>
                    <form method="post" enctype="multipart/form-data">
                      <table width="<?php echo $frm_tbl_width;?>" cellpadding="3" cellspacing="0" align="center" border="0">
                        ...
                        <tr>
                          <td width="83" nowrap class="Verdana_Black_11" valign="top">Description*</td>
                          <td width="9" class="Verdana_Black_11">:</td>
                          <td width="487" class="Verdana_Black_11"><textarea name="description" id="description" class="txtin" style="height: 148px;
    width: 388px;"><?php echo $description; ?></textarea></td>
                        </tr>
                        <tr>
                  ...
                  <td colspan="2"><!--CONTENTS TABLE-->
                    ...
                    <table cellpadding="4" cellspacing="0" width="99%" align="center">
                      <tr>
                        ...
                        <td width="18%" class="content_table_head_td" align="center">Email</td>
                      ...
                      <tr bgcolor="<?php echo $bgColor;?>">
                        ...
                        <td align="center" valign="top" class="content_table_data_td_border_lb"><?php echo hlpHtmlSlashes($Data_Row['description']); ?>&nbsp;</td>
...
if($paging)
										...
										?>
                      <tr>
                        <td colspan="6" class="paginationClass" align="center"><span><?php echo $paging; ?></span></td>
                      </tr>
                      <?php
										}
									}
									else
									{
										?>
                      <tr>
                        <td colspan="6" class="content_table_data_td_border_lrb">Record not found.</td>
                      </tr>
                      <?php
									}
								  ?>
