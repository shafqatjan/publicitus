...
$objDb->connect();
$objUsers = new User();
$objUserMedia = new UserMedia();
$$objMediaType = new Categories();
...
$link_URL = "user-media-manage.php?start=".$start."&user=".$userId;
$_pageurl = "user-media-manage.php?user=".$userId;
...
{ 
	...
	//$sql = $objUserMedia->PopulateGrid("*"," AND id = ".$delid);
...
//	printArray($_GET);
	$objUserMedia->id = $delid;
	$sql = $objUserMedia->Delete();
...
{ 
	$objUserMedia->id = $editid; 
	$objUserMedia->status = $status;	
   	$sql = $objUserMedia->UpdateStatus();
...
$total = $objDb->GetCountSql($objUserMedia->table,$qry); 
...
$sql = $objUserMedia->PopulateGrid("*",$qry);  
          ...
          <tr>
            ...
            <td valign="top" align="center">
              <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tbllisting">
                <tr>
                  <td colspan="2" align="left" class="mainhead">Manage User Medias</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="44%" align="right" class="Verdana_Bold_11_Link"><a title="Active"><img src="../images/active.gif">Active User Media</a> <a title="Active"><img src="../images/inactive.gif">Inactive User Media</a>&nbsp;| &nbsp;<a href="<?php echo $backToExpert?>">Back</a></td>
                </tr>
                <tr>
                    ...
                    <table cellpadding="4" cellspacing="0" width="99%" align="center">
                      <tr>
                       <!-- <td width="22%" class="content_table_head_td" >Username&nbsp; <a href="<?php echo $link_URL;?>&sort=desc&field=user_name"><img src="../images/up.png" height="8" border="0" /></a> <a href="<?php echo $link_URL;?>&sort=asc&field=user_name"><img src="../images/down.png" height="8" border="0"/></a></td> -->
                        <td width="31%" class="content_table_head_td" align="center">Media</td>
                        <td width="27%" class="content_table_head_td" align="center">Status</td>
                        <td width="16%" class="content_table_head_td" align="center">Dated</td>
                      ...
                      <tr bgcolor="<?php echo $bgColor;?>">
                        <td align="center" valign="top" class="content_table_data_td_border_lrb"><?php 
							echo $objDb->get_field($$objMediaType->table,'title',$Data_Row['media_id'],""); ?>&nbsp;</td>
