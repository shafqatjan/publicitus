...
$link_URL = "category-manage.php?start=".$start;
$_pageurl = "category-manage.php";
...
{ 
	$objCat->id = $editid; 
	$objCat->status = $status;	
   	$sql = $objCat->StatusUpdate();
...
if($act == "edit" && $editid)
{
	$sql = $objCat->PopulateGrid("*"," AND id = ".$editid);
...
if(isset($_POST['btn_save']))
{
	...
	$error .= $objCat->validate();
	if(!$error)	
	{
		if($objCat->id)
			  $sqlusername = $objCat->PopulateGrid("1", " AND title = '".$objCat->title."' AND id !=".$objCat->id);
		 else 
			  $sqlusername = $objCat->PopulateGrid("1", " AND title ='".$objCat->title."'");
...
$total = $objDb->GetCountSql($objCat->table); 
...
<link rel="stylesheet" type="text/css" href="../plugin/facebox/facebox.css"/>
<script language="javascript" src="../js/lib/jquery.js"></script>
<script language="javascript" src="../js/default.js"></script>
<script language="javascript" src="../js/admin.js"></script>
<script language="javascript" src="../plugin/facebox/facebox.js"></script>
          ...
          <tr>
            ...
            <td valign="top" align="center">
              <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tbllisting">
                <tr>
                  <td colspan="2" align="left" class="mainhead">Manage Categories</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="24%" align="right" class="Verdana_Bold_11_Link"><a title="Active"><img src="../images/active.gif">Active Category</a> <a title="Active"><img src="../images/inactive.gif">Inactive Category</a>&nbsp;</td>
                </tr>
                <tr>
