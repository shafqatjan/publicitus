...
$prifileId=isset($_GET['prifile_id']) ? intval($_GET['prifile_id']) : '' ;
$sql = $objUser->PopulateGrid("*"," AND id= ".$prifileId);  
...
// Retrieve Categories 
    ...
    <input type="button" value="Back" onclick="window.location='<?php echo SITE_ROOT.'manager/expert.php';?>'">
   </div> <!-- form warrper -->
  </form>
  </div> <!-- content -->
